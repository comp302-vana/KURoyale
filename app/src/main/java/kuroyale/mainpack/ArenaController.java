...
public class ArenaController {
    ...
    @FXML private Pane ourtower;
    @FXML private Pane enemytower;
    @FXML private Pane ourking;
    @FXML private Pane enemyking;
    @FXML private Pane bridge;
        ...
        for (int row = 0; row < 18; row++) {
            for (int col = 0; col < 10; col++) {
                ...
                tile.setOnDragDropped(event -> {
                    ...
                    tile.setStyle("-fx-background-color: #FFCDD2; -fx-border-color: #E57373; -fx-border-width: 1;");
...
private void loadDefaultArenaIfExists() {
    try {
        ...
        if (!f.exists()) return; // no default set
